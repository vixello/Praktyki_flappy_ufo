...
public class CameraWork : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        // if player goes out of SceneCamera bounds, game over
    ...
    private void Follow()
    {
        ...
        float moveY = 5f * Mathf.Sin(angleInRadians) * Time.fixedDeltaTime;

        // if SceneCamera position is out of bounds
        Vector3 camerBoundPosition = new Vector3(
            Mathf.Clamp(targetPosition.x,CameraMinValues.x, targetPosition.x + 60f),
